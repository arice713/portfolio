                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="detailsModalLabel">Person Details</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <th>First Name:</th>
                                    <td id="person-firstName"></td>
                                </tr>
                                <tr>
                                    <th>Last Name:</th>
                                    <td id="person-lastName"></td>
                                </tr>
                                <tr>
                                    <th>Company:</th>
                                    <td id="person-company"></td>
                                </tr>
                                <tr>
                                    <th>Phone:</th>
                                    <td id="person-phone"></td>
                                </tr>
                                <tr>
                                    <th>Email:</th>
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    <label for="edit-email" 
                                           class="col-md-4 control-label">Email:</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="edit-email" placeholder="Email (merp@meow.com)" />
                                    </div>
                                </div>
                                <div class="form-group">
