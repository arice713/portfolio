            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="person"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <sf:errors path="firstName" cssClass="bg-danger"></sf:errors>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <sf:errors path="lastName" cssClass="bg-danger"></sf:errors>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <sf:input type="text" class="form-control"
                                  ...
                                  path="company"
                                  placeholder="Company" />
                        <sf:errors path="company" cssClass="bg-danger"></sf:errors>
                    ...
                    <div class="form-group">
                        ...
                        <sf:input type="text" class="form-control"
                                  ...
                                  path="email"
                                  placeholder="Email" />
                        <sf:errors path="email" cssClass="bg-danger"></sf:errors>
                    ...
                    <div class="form-group">
                        ...
                        <sf:input type="text" class="form-control"
                                  ...
                                  path="phone"
                                  placeholder="Phone" />
                        <sf:errors path="phone" cssClass="bg-danger"></sf:errors>
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" id="edit-button"
                                class="btn btn-default">Update Person</button>
                    </div>
                </div>
            </sf:form>
        </div>
